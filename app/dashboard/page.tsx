import { Award, BookOpen, CheckCircle, Clock, Download, FileText } from "lucide-react"
...
export default function DashboardPage() {
  return (
    <DashboardShell>
      <DashboardHeader heading="Dashboard" text="Overview of your quiz performance and activity.">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
            ...
            <Card className="col-span-3">
              <CardHeader>
                ...
                <CardDescription>You've completed 12 quizzes this month.</CardDescription>
              </CardHeader>
              <CardContent>
                <RecentQuizzes />
              </CardContent>
